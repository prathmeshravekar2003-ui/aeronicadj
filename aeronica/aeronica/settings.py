"""
Django settings for aeronica project.
...
# Set this as DJANGO_SECRET_KEY in your Vercel environment variables
SECRET_KEY = os.environ.get(
    'DJANGO_SECRET_KEY',
    'django-insecure-o#5f%_s(diij@$kcu)=@&qrxv9*8h&n_5ugk3kj6^*qut4xaj6'
)
